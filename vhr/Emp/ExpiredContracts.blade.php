                          ...
                          <div class="col-md-6">
                              <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a data-route="{{ route('ActCont', ['id'=>$data->id]) }}" data-msg="You sure you want to activate this staff member's contract"  class="dropdown-item deleteConfirm" href="#">Activate Contract</a></li>
