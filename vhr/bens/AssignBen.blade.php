	...
	<div class="alert alert-primary">
	    ...
	    <div class="d-flex flex-column">
	        ...
	        <!--end::Title-->
	        <!--begin::Content-->
	        <span>Use this interface to manage beneficiaries attached to the selected staff member </span>
	        <!--end::Content-->
	    </div>
	    <!--end::Wrapper-->
	</div>
	    ...
	    <table class=" mytable table table-rounded table-bordered  border gy-3 gs-3">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td> <a data-bs-toggle="modal" class="btn btn-dark btn-sm " href="#MoreInfor{{$data->id}}"><i
	                            class="fas fa-binoculars" aria-hidden="true"></i></a></td>

	                <td> <a data-route="{{ route('DeleteBenAss', ['id'=>$data->id]) }}"
	                        data-msg="You sure you want to delete this beneficiary. This action is not reversible"
	                        ...
	                        <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                    ...
	                                    <a data-fslightbox="lightbox-basic" href="{{ asset($data->IDScan) }}"
	                                ...
	                                <td>
	                                    ...
	                                    <a data-fslightbox="lightbox-basic" href="{{ asset($data->Photo) }}"
	                                        class="btn btn-sm bg-dark">
