    ...
    <div class="card-body pt-3 bg-light shadow-lg table-responsive">
        {{ HeaderBtn($Toggle="NewContract", $Class="btn-danger", $Label="New Contract", $Icon="fa-plus")}}
                          ...
                          <div class="col-md-6">
                              <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a data-route="{{ route('TerminateCon', ['id'=>$data->id]) }}" data-msg="You sure you want to end this staff member's contract"  class="dropdown-item deleteConfirm" href="#">Terminate Contract</a></li>
                          ...
                          <div class="col-md-6">
                              <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                      ...
                                      <li><a data-msg="You want to delete this staff member's record, This action is not reversible!!" data-route="{{ route('DelCon', ['id'=>$data->id]) }}" class="dropdown-item deleteConfirm" href="#">Delete Record</a></li>
                                  </ul>
                                </div>
                          </div>
                      </td>
