    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Create a new contract category
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('NewCat') }}" class="row" method="POST" enctype= multipart/form-data>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3 mt-3 x_{{$data['name']}}">
                            <div class="mb-3">
                                ...
                                <input required type="text" name="{{$data['name']}}" class="form-control " placeholder="e.g Consultant" />
                            </div>
                        </div>
